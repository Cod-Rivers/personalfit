    ...
    return (
        <>
            ...
            <div className="container py-5">
                ...
                <ClientOnly fallback={<div className="text-center py-4"><div className="spinner-border text-light" role="status"></div></div>}>
                    <div className="row g-4">
                        {trainings.map((protocol) => (
                            <div className="col-12 col-md-6" key={protocol.id} style={{ minHeight: "50px" }} onClick={() => router.push("/app/treinamento/" + protocol.id)}>
