...
import { IQuestionProps, IquestionsRendererProps } from './types';
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...
                                    border:
                                        answers[option.question_id] ===
                                        option.answer_id
                                            ? '3px solid var(--color-gold)'
                                            : '3px solid transparent',
                                }}
                                onClick={() =>
                                    handleRadioChange(option.answer_id)
                                }
                            >
                                <label
                                    htmlFor={option.question_id}
                                    className="fw-fold d-flex align-items-center"
                                >
                                    {option.text}
                                </label>
                            </button>
