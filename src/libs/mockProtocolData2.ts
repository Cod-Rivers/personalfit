...
const allProtocolsData: ProtocolData = {
    ...
    "user1_protocolo_extra": {
        user: { id: "user1", name: "Usuário Protocolo Extra" },
        trainings_progress: [
            { id: "tp5-p1", user_id: "user1", training_id: "t3", reference: "C", exercise_logs: [] },
        ]
    },*/
};
